...
public class FileUtils {
    ...
    public static File writeToSDFromBytes(String path, String fileName, byte[] input){
        File file = null;
    ...
    public static File writeToCacheFromInput(String path, String fileName, InputStream input){
        File file = null;
        OutputStream output = null;
        try {
            createSDDir(path);
